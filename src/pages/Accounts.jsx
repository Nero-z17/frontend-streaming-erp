                ...
                {platformAccounts.map((acc) => (
                  <div key={acc.id_acct} className="bg-white shadow-sm border-3 border-blue-500 dark:bg-gray-800 p-4 rounded-xl dark:border-gray-700 flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-2 pt-3 border-t border-gray-100 dark:border-gray-700">
                      ...
                      <button onClick={() => setEditingAccount({...acc, renewal_date_acct: new Date(acc.renewal_date_acct).toISOString().split('T')[0]})} className="bg-orange-50 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 py-2 rounded-lg text-xs font-bold transition">Éditer</button>
